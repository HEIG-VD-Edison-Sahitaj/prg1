...
string montantEnToutesLettres(long double montant) {
    ...
    long long int intergerPart = montant;
    long long int valeurMil = montant * 1000;
    long long int troisiemeDecimale = valeurMil % 10;
    long long int decimalPart = (montant-intergerPart)*100;
